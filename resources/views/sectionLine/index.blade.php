...
@section('content')
    <div class="container-fluid p-4">
        <div class="mb-4">
            <h4 class="font-weight-bold mb-1" style="color: var(--text-main); font-size: 1.5rem;">Manage Sections/Lines</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 small" style="margin-bottom: 0;">
                    ...
                    <li class="breadcrumb-item active text-muted" aria-current="page">Section/Line</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="javascript:void(0);" data-url="{{ route('admin.section_line.create') }}" data-ajax-popup="true"
                data-title="Create New Section/Line"
    ...
    <div class="data-table-card-container container-fluid" data-fetch-url="{{ route('admin.section_line.getSectionLineData') }}">
