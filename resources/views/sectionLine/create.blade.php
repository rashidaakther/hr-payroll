<form action="{{ route('admin.section_line.store') }}" method="POST" id="HrSetUpForm">
    @csrf
    <div class="modal-body text-left p-0">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="form-group mb-3">
                    <label for="unit_id" class="form-label font-weight-bold text-success small text-uppercase mb-2">
                        Unit
                    </label>
                    <div class="form-icon-user position-relative">
                        <select class="form-control border-0 px-3 py-2 text-white" name="unit_id" id="unit_id" required
                            style="background-color: var(--bg-input); border: 1px solid var(--input-border) !important; border-radius: 6px; font-size: 0.95rem;">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="form-icon-user position-relative">
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Enter Section / Line"
                            style="background-color: var(--bg-input); border: 1px solid var(--input-border) !important; border-radius: 6px; font-size: 0.95rem;">
                    </div>
