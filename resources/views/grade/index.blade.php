...
@section('content')
    <div class="container-fluid p-4">
        <div class="mb-4">
            <h4 class="font-weight-bold mb-1" style="color: var(--text-main); font-size: 1.5rem;">Manage Grades</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 small" style="margin-bottom: 0;">
                    ...
                    <li class="breadcrumb-item active text-muted" aria-current="page">Grade</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="javascript:void(0);" data-url="{{ route('admin.grade.create') }}" data-ajax-popup="true"
                data-title="Create New Grade"
    ...
    <div class="data-table-card-container container-fluid" data-fetch-url="{{ route('admin.grade.getGradeData') }}">
            ...
            <div class="col-12">
                <div class="responsive-table-overflow-wrapper">
                    <table class="core-structured-dark-table">
                        <thead>
                            <tr>
                                <th data-sort="name" style="cursor: pointer;">{{ __('Grade') }} <i
                                        class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
                                <th data-sort="branch_id" style="cursor: pointer;">{{ __('Branch') }} <i
                                        class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
                                <th data-sort="basic_sly" style="cursor: pointer;">{{ __('Basic') }} <i
                                        class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
                                <th data-sort="house_rent" style="cursor: pointer;">{{ __('H.Rent') }} <i
                                        class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
                                <th data-sort="medical_allowance" style="cursor: pointer;">{{ __('Medical') }} <i
                                        class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
                                <th data-sort="transportation_allowance" style="cursor: pointer;">{{ __('Transport') }} <i
                                        class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
                                <th data-sort="food_allowance" style="cursor: pointer;">{{ __('Food') }} <i
                                        class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
                                <th data-sort="total_approx_sly" style="cursor: pointer;">{{ __('Total') }} <i
                                        class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
