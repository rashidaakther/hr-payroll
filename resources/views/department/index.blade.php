...
@section('content')
    <div class="container-fluid p-4">
        <div class="mb-4">
            <h4 class="font-weight-bold mb-1" style="color: var(--text-main); font-size: 1.5rem;">Manage Department</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 small" style="margin-bottom: 0;">
                    ...
                    <li class="breadcrumb-item active text-muted" aria-current="page">Department</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="javascript:void(0);" data-url="{{ route('admin.department.create') }}" data-ajax-popup="true"
    ...
    <div class="data-table-card-container container-fluid" data-fetch-url="{{ route('admin.department.getDepartmentData') }}">
                        ...
                        <thead>
                            <tr>
                                <th data-sort="name" style="cursor: pointer;">
                                    Department Name <i class="fa-solid fa-sort sort-indicator-caret-icon"></i>
                                </th>
