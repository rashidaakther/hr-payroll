...
@section('content')
    <div class="container-fluid p-4">
        <div class="mb-4">
            <h4 class="font-weight-bold mb-1" style="color: var(--text-main); font-size: 1.5rem;">Manage Units</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 small" style="margin-bottom: 0;">
                    ...
                    <li class="breadcrumb-item active text-muted" aria-current="page">Unit</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="javascript:void(0);" data-url="{{ route('admin.unit.create') }}" data-ajax-popup="true"
    ...
    <div class="data-table-card-container container-fluid" data-fetch-url="{{ route('admin.unit.getUnitData') }}">
            ...
            <div class="col-12">
                <div class="responsive-table-overflow-wrapper">
                    <table class="core-structured-dark-table">
                        <thead>
                            <tr>
                                <th data-sort="name" style="cursor: pointer;">{{ __('Unit Name') }} <i
                        ...
                        <tbody>
                            <!-- AJAX এর মাধ্যমে ডেটা এখানে রেন্ডার হবে -->
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        <div class="row pt-3">
            <div class="col-12 table-entries-summary-counter-label">
                <!-- Summary counters auto load here -->
            </div>
        </div>
    </div>
@endsection