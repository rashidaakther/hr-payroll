...
@section('content')
    <div class="container-fluid p-4">
        <div class="mb-4">
            <h4 class="font-weight-bold mb-1" style="color: var(--text-main); font-size: 1.5rem;">Manage Settings</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 small" style="margin-bottom: 0;">
                    ...
                    <li class="breadcrumb-item active text-muted" aria-current="page">Setting</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="javascript:void(0);" data-url="{{ route('admin.setting.create') }}" data-ajax-popup="true"
                data-title="Create New Religion"
    ...
    <div class="data-table-card-container container-fluid" data-fetch-url="{{ route('admin.setting.getSettingData') }}">
            ...
            <div class="col-12">
                <div class="responsive-table-overflow-wrapper">
                    <table class="core-structured-dark-table">
                        <thead>
                            <tr>
                                <th data-sort="name" style="cursor: pointer;">{{ __('Setting Type') }} <i class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
                                <th data-sort="value" style="cursor: pointer;">{{ __('Value') }} <i class="fa-solid fa-sort sort-indicator-caret-icon"></i></th>
