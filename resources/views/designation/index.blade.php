...
@section('content')
    <div class="container-fluid p-4">
        <div class="mb-4">
            <h4 class="font-weight-bold mb-1" style="color: var(--text-main); font-size: 1.5rem;">Manage Designation</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 small" style="margin-bottom: 0;">
                    ...
                    <li class="breadcrumb-item active text-muted" aria-current="page">Designation</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="javascript:void(0);" data-url="{{ route('admin.designation.create') }}" data-ajax-popup="true"
    ...
    <div class="data-table-card-container container-fluid" data-fetch-url="{{ route('admin.designation.getDesignationData') }}">
                        ...
                        <thead>
                            <tr>
                                <th data-sort="name" style="cursor: pointer;">
                                    Designation <i class="fa-solid fa-sort sort-indicator-caret-icon"></i>
                                </th>
                                <th data-sort="department_id" style="cursor: pointer;">
                                    Department <i class="fa-solid fa-sort sort-indicator-caret-icon"></i>
                                </th>
                                <th data-sort="branch_id" style="cursor: pointer;">
                                    Branch <i class="fa-solid fa-sort sort-indicator-caret-icon"></i>
                                </th>
